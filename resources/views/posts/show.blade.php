                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="my-0 ml-1 text-dark"> <strong> - Pengikut </strong></p>
                                </div>
                            </div>
                                        ...
                                        <div class="modal fade" id="sharebtn{{$post->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <ul class="list-group">
                                                    ...
                                                    <li class="btn list-group-item" data-dismiss="modal" onclick="copyToClipboard('copy_{{ $post->id }}')">Salin Link</li>
                                ...
                                <form action="{{ action('CommentController@store') }}" method="POST">
                                    ...
                                    <div class="form-group mb-0 text-muted">
                                        <div class="input-group is-invalid">
                                            ...
                                            <textarea class="form-control py-2 px-3" id="body" name='body' rows="1" placeholder="Tambah Komentar..."></textarea>
                                            <div class="input-group-append">
                                                <button class="btn btn-md btn-outline-info" type="submit">Posting</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
