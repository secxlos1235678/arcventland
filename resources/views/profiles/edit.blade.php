                ...
                <div class="card-body">
                    <form method="POST" action="/profile/{{ $user->username }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? $user->name }}" autocomplete="Nama" autofocus>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-6">
                                <input id="website" type="text" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website') ?? $user->profile->website }}" autocomplete="Situs Baru">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="image" class="col-md-4 col-form-label text-md-right"><strong>Ganti Foto Profil</strong></label> 
