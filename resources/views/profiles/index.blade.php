...
<div class="container">
    <div class="row ">
        ...
        <div class="col-9 pt-5">
            ...
            <div class="d-flex">
                <div class="pr-5"><strong> {{ $postCount }} </strong> posting</div>
                <div class="pr-5"><strong> {{ $followersCount }} </strong> Pengikut</div>
                <div class="pr-5"><strong> {{ $followingCount }} </strong> Mengikuti</div>
            </div>
